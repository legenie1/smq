            ...
            <div class="card-body">
                <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="name" name="name" placeholder="Ex: Tour 1" class="form-control"
                    ...
                    <div class="form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="start_time" placeholder="Ex: 2022-02-21  12:02:14" name="start_time" class="form-control datetime"
                    ...
                    <div class="form-group {{ $errors->has('end_time') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="end_time" name="end_time" placeholder="Ex: 2022-02-21  17:02:14" class="form-control datetime"
